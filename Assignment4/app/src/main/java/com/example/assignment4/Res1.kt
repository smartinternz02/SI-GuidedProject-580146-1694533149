...
fun Res1(){
    Column(modifier=Modifier.background(Color.White)){
        ...
        Card(modifier=Modifier
            ...
            Row(modifier = Modifier.padding(10.dp)) {
                Image(
                    painter = painterResource(id = R.drawable.mpizz),
                    contentDescription = "Mexican green wave pizza picture",
                    modifier = Modifier.size(100.dp)
                )
                Column(modifier=Modifier.padding(5.dp)) {
                    Heading1(name = "Mexican Green Wave Pizza")
                    Body1(content = "Made with delicious marinated vegetables, paneer,olives and corn")
                    Row(modifier=Modifier.padding(10.dp)) {
        ...
        Card(modifier=Modifier
            ...
            Row(modifier = Modifier.padding(10.dp)) {
                ...
                Column(modifier=Modifier.padding(5.dp)) {
                    Heading1(name = "Veg Burger")
                    Body1(content = "Veg burger made with aloo patty,lettuce,tomato slices and layered with paprika sauce")
                    Row(modifier=Modifier.padding(10.dp)) {
        ...
        Card(modifier=Modifier
            ...
            Row(modifier = Modifier.padding(10.dp)) {
                ...
                Column(modifier=Modifier.padding(5.dp)) {
                    Heading1(name = "Chicken Burger")
                    Body1(content = "Burger made with Chicken patty,lettuce,tomato slices and paprika sauce")
                    Row(modifier=Modifier.padding(10.dp)) {
